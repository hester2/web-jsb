<template>
  <div class="gd-addGoods-main">
    <p class="gd-addGoods-title">首页<span>></span>
      <router-link to="/user/productTable/product"><span>产品类表</span></router-link><span>></span><span class="gd-addGoods-cor">编辑商品</span>
    </p>
