<template>
  <div class="gd-goodsPre-main">
    <p class="gd-goodsPre-title">首页<span>></span>
      <router-link to="/user/productTable/product"><span>产品类表</span></router-link><span>></span>
      <router-link to="/user/productTable/product"><span>添加商品</span></router-link>
      <span>></span>
      <span class="gd-goodsPre-cor">预览商品</span>
    </p>
          ...
          <div class="gd-preview-center">
            ...
            <div class="gd-preview-cirm">
              <div v-for="(item,index) in list" :key="index" class="gd-preview-specifications">
                ...
                <p class="gd-preview-inv">库存:{{ item.goodsStockVo.num }}</p>
...
export default {
  ...
  created() {
    ...
    console.log(this.$route.query.dataForm)
    ...
    handleSave() {
      ...
      updateGoodsStatus({
        ...
        if (response.code == 200) {
          ...
          this.$router.push({
            path: '/user/productTable/product'
          })
        }
      })
    },
